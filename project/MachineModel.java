...
public class MachineModel {
	...
	public final TreeMap<Integer,Instruction> INSTRUCTIONS = new TreeMap<Integer,Instruction>();
	...
	public MachineModel(boolean gui, HaltCallback cb) {
        ...
        //INSTRUTION_MAP entry for "JMPZI"
	...
	//GETTERS
	public int[] getCode() {return memory.getCode();}
	public int getOp(int i) {return memory.getOp(i);}
	public int getArg(int i) {return memory.getArg(i);}
	public int[] getData() {return memory.getData();}
	public int getData(int index) {return memory.getData(index);}
	public int getAccumulator() {return cpu.accumulator;}
	public int getInstructionPointer() {return cpu.instructionPointer;}
	public int getMemoryBase() {return cpu.memoryBase;}
	public Instruction get(int index) {return INSTRUCTIONS.get(index);}
	public Job getCurrentJob() {return currentJob;}
	public int getChangedIndex() {return memory.getChangedIndex();}
	public String getHex(int i) {return memory.getHex(i);}
	public String getDecimal(int i) {return memory.getDecimal(i);}
	public States getCurrentState() {return currentJob.getCurrentState();}

	//SETTERS
	public void setCode(int index, int op, int arg) {memory.setCode(index, op, arg);}
	public void setData(int index, int value) {memory.setData(index, value);}
	public void setAccumulator(int val) {cpu.accumulator = val;}
	public void setInstructionPointer(int val) {cpu.instructionPointer = val;}
	public void setMemoryBase(int val) {cpu.memoryBase = val;}
	...
	public void step() {
		try {
			if(cpu.instructionPointer < currentJob.getStartcodeIndex() || cpu.instructionPointer >= currentJob.getStartcodeIndex()+currentJob.getCodeSize()) {
				throw new CodeAccessException("IP is not in code range");
			}
	...
	public void setJob(int i) {
		if(i != 0 && i != 1) {
			throw new IllegalArgumentException("Job must be 0 or 1");
		}
